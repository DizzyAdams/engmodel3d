    ...
    return (<div className="dashboard-stack">
      <section className="panel panel--hero panel--feature">
        ...
        <div className="metric-row">
          {data.stats.map((stat) => (<div className="metric-card" key={stat.label}>
      ...
      <div className="dashboard-grid">
        ...
        <section className="panel panel--stacked" id="projects">
          ...
          <div className="project-list">
            {data.projects.map((project) => (<a className="project-row" href={`/projects/${project.id}`} key={project.id}>
                <div className="project-row__title">
      ...
      <section className="panel panel--wide panel--stacked">
        ...
        <div className="metric-row">
          {data.kpis.map((kpi) => (<div className="metric-card" key={kpi.label}>
              <span>{kpi.label}</span>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="calc-grid">
          {data.calculations.map((item) => (<article className="intent-card" key={item.label}>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="snapshot-grid">
          {data.engineeringSnapshot.map((item) => (<article className="snapshot-card" key={item.label}>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="feature-grid">
          {data.governance.map((item) => (<article className="feature-card" key={item.label}>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="comparison-grid">
          {data.exports.map((target) => (<article className="comparison-card" key={target.format}>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="feature-grid">
          {data.capabilities.map((feature) => (<article className="feature-card" key={feature.name}>
              <div className="feature-card__top">
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="roadmap-grid">
          {data.roadmap.map((item) => (<article className="roadmap-card" key={item.phase}>
      ...
      <section className="panel panel--stacked panel--wide">
        ...
        <div className="comparison-grid">
          {data.comparisonTheme.map((item) => (<article className="comparison-card" key={item.label}>
              <span>{item.label}</span>
              <strong>{item.value}</strong>
              <p>{item.detail}</p>
            </article>))}
